...
public class UnknownActivity extends AppCompatActivity {
    ...
    public void initNavigationDrawer() {
        ...
        NavigationView navigationView = (NavigationView)findViewById(R.id.unknown_navigation_view);
